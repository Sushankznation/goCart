...
const HomePage = () => {
// Define dispatch and state variables
...
// Fetch products, categories and products by category on component mount
useEffect(() => {
...
// Render home page with slider, category list, product list and single category components
return (
